  ...
  return (
    <div className="h-screen flex items-center sm:flex-col">
      ...
      <div className={`w-1/2 px-10 space-y-5 sm:w-screen `}>
        ...
        <p className="text-lg">
          Welcome to goodNews, your go-to destination for staying updated with
          the latest news and trends from around the world. Our platform
          provides a seamless and engaging experience, delivering news content
